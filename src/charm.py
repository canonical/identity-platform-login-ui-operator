...
from integrations import HydraEndpointData, KratosInfoData, TracingData, PublicRouteData
from services import PebbleService, WorkloadService
from utils import normalise_url, leader_unit
...
class IdentityPlatformLoginUiOperatorCharm(CharmBase):
    ...
    def _domain_url(self) -> Optional[str]:
        return normalise_url(str(PublicRouteData.load(self.public_route).url)) if self.public_route.is_ready() else None
